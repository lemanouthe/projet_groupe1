Vue.component('my_team', {
    props: [],
    template: `<section id="gtco-team" class="bg-white section-padding">
    <div class="container">
        <div class="section-content">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        <img class="img-fluid" src="/static/img/chef-2.jpg" alt="">
                        <div class="team-desc">
                ...
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        <img class="img-fluid" src="/static/img/chef-3.jpg" alt="">
                        <div class="team-desc">
